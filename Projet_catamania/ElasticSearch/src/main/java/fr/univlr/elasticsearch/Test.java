...
public class Test {
    ...
    public static void main(String[] args) throws UnknownHostException, NoSuchAlgorithmException, InterruptedException, UnsupportedEncodingException {
        ...
        //es node refreshes
        Thread.sleep(1000);
        JSONObject test2 = driver.search("users", "credentials", "username", "1", true);
        JSONObject test3 = driver.searchSorted("users", "credentials", "email", "mdr", "username.keyword", true, false);
