...
public class ElasticSearchDriver {
     ...
     * @param index Index sur lequel le document va être indexé
     * @param type Type de document à indexer
     * @param jsonData Corps du document à indexer de type Map (mapping)
     * @return Affichage de l'élément indexé
     */
     ...
     *
     * @param index Index sur lequel le document va être indexé
     * @param type Type du document à indexer
     * @param id Id du document à indexer
     * @param jsonData Corps du document à indexer de type Map (mapping)
     * @return Affichage de l'élément indexé
     */
     ...
     *
     * @param index Index sur lequel le document va être recherché
     * @param type Type de document à rechercher
     ...
     * @param wildcard Utlisation d'une wildcard dans la recherche
    ...
    public JSONObject search(String index, String type, String field, String query, boolean wildcard) {
        ...
        /**
     * Fonction de recherche avec une fonction de tri sur un champ passé en paramètre.
     *
     * @param index Index sur lequel le document va être recherché
     * @param type Type de document à rechercher
     * @param field Champ du document sur lequel la recherche va s'appliquer
     * @param query Requête avec laquelle la recherche doit correspondre
     * @param fieldsort Champ sur lequel s'applique le tri
     * @param wildcard Utlisation d'une wildcard dans la recherche
     * @param asc true=tri ascendant false=tri descendant
     * @return
     */
    public JSONObject searchSorted(String index, String type, String field, String query, String fieldsort, boolean wildcard, boolean asc) {
     ...
     /**
     * Fonction de recherche personnalisé avec la syntaxe Lucene
     * 
     * @param index Index sur lequel le document va être recherché
     * @param type Type de document à rechercher
     * @param queryString Requête avec laquelle la recherche doit correspondre
     * @return JSONObject
     */
