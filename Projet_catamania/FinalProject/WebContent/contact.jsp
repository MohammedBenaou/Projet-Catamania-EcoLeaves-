				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-left">
							...
							<li><a href="events_list.jsp" class="btn w3ls-hover">Evénement</a></li>
			...
			<div class="footer-agileinfo"> 
				...
				<div class="col-md-3 col-sm-3 footer-wthree-grid">
					...
					<ul>
						...
						<li><a href="events_list.html"><span class="glyphicon glyphicon-menu-right"></span> EvÃ©nement</a></li>
						<li><a href="troc.html"><span class="glyphicon glyphicon-menu-right"></span> Ã‰change</a></li>
