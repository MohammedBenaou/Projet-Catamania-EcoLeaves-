...
">
		...
		<div class="col-md-8">
			<!--event-->
			<iframe src="https://calendar.google.com/calendar/embed?src=25r56n2fcsptbmlqjo5tffdvg0%40group.calendar.google.com&ctz=Europe%2FParis" style="border: 0" width="100%" height="600" frameborder="0" scrolling="no"></iframe>
	...
	<div class="footer-agile">
		<div class="container">
			<div class="footer-agileinfo"> 
				...
				<div class="col-md-3 col-sm-3 footer-wthree-grid">
					...
					<ul>
						...
						<li><a href="events_list.html"><span class="glyphicon glyphicon-menu-right"></span> Événement</a></li>
						<li><a href="troc.html"><span class="glyphicon glyphicon-menu-right"></span> É‰change</a></li>
			...
			<div class="copy-right"> 
				<p>Â© 2017 EcoLeaves . All rights reserved </p>
			</div>
		</div>
	</div> 
	<!-- //footer end here -->  
